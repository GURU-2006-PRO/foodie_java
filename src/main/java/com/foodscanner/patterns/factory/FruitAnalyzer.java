...
public class FruitAnalyzer implements NutrientAnalyzer {
    @Override
    public String buildPrompt(String foodName) {
        return """
            ...
            Provide a detailed JSON response with EXACTLY this structure:
            {
              ...
              "health_warnings": {
                "diabetes": "specific warning if high sugar else safe",
                "hypertension": "warning or safe message",
    ...
    @Override
    public String getCategory() { return "Fruit"; }
}
